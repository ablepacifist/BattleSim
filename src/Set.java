...
public Set hasTarget(Unit inRange){
    ...
    public interface NodeInterface {
        ...
        Unit getUnit();
        void printGUI(JTextArea outputArea);
    }
...
@Override
public void printGUI(JTextArea outputArea) {
    if (unit != null) {
        String info = String.format(
            "%s (%s): %d/%d HP, Exhausted = %b.%n",
            unit.getName(),
            unit.getType(),
        ...
        SwingUtilities.invokeLater(() -> outputArea.append(info)); // Ensure this runs on the EDT
        System.out.println(info); // Debug: Print to console
    } else {
        SwingUtilities.invokeLater(() -> outputArea.append("No unit information available.\n"));
        System.out.println("No unit information available."); // Debug: Print to console
    }
}
